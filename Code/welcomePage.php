  ...
  ?>
    ...
    <div class="row cardContainer">
        ...
        ?>
                ...
                <a class="m-4 mt-3" href=?page=settings.php><button class="btn btn-pwd btn-warning">Change
                        Password</button></a>
            </div>
        </div>
        <div class="col-sm-12 col-md-3">
                ...
                <form method="post" class="mt-2" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <div class="form-group-row center">
                        <div class="col-sm-12 my-1">
                            <input name="itemTitle" type="text" class="form-control" id="itemTitle"
                                placeholder="Title" />
                        </div>
                        <div class="col-sm-12 my-1">
                            <input name="itemDesc" type="text" class="form-control" id="itemDesc"
                                placeholder="Description" />
                        </div>
                        <div class="col-sm-12 my-1">
                            <input name="itemPrice" required min="0" type="number" step="0.01" class="form-control"
                                id="itemPrice" placeholder="Price $0.00">
                        </div>
                        <div class="col-sm-8 my-1">
