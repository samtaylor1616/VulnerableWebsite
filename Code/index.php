 ...
 * -----
 * Purpose: Login and registration page. Includes simplistic but naive cookie 'Remember me' cookie.
*/
          ...
          <div class="col-sm-12 col-xl-7 mx-auto">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-group">
                <input name="usernameLogin" type="text" class="form-control my-input" id="username" placeholder="Username"
      ...
      <div class="col-sm-12 col-md-6">
        ...
        <div class="row">
          <div class="col-sm-12 col-xl-7 mx-auto">
            <form method="post">
              <div class="form-group">
                <input name="registerUsername" type="text" class="form-control my-input" id="registerUsername"
                  placeholder="Username">
              </div>
              <div class="form-group">
                <input name="registerPassword" type="password" class="form-control my-input" id="registerPassword"
                  placeholder="Password">
              </div>
              <div class="form-group">
                <input name="registerConfirm" type="password" class="form-control my-input" id="registerConfirm"
                  placeholder="Confirm Password">
              </div>
              <button class="btn loginBtn" type="submit">Create New Account</button>
              <p class="small mt-2">By signing up, you are indicating that you have read and agree to the <a href="#"
                  class="ps-hero__content__link">Terms of Use</a> where it states you will not hack
                us.
              </p>
            </form>
          </div>
